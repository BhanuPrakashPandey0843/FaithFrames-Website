    ...
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center text-center overflow-hidden py-20 px-6 bg-gradient-to-b from-blue-50 via-white to-blue-100">
      ...
      >
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight">
          Simple, Honest, and <span className="text-blue-600">Lifetime Pricing</span>
        </h1>
        <p className="text-gray-600 mt-5 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto">
          Enjoy unlimited access to all <span className="font-semibold text-gray-800">Bible wallpapers</span>,
          verses, and faith-inspired designs — with a one-time payment.  
          No subscriptions, no renewals, just pure inspiration forever.
        </p>
      </motion.div>
