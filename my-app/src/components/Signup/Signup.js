          ...
          <div className="mt-10 flex flex-col items-center">
            ...
            <div className="w-full flex-1 mt-8">
              ...
              <div className="flex flex-col items-center">
                ...
                {/* GitHub */}
                <button className="w-full max-w-xs mt-4 font-semibold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 hover:shadow-lg">
